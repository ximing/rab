  ...
  describe("列表操作场景", () => {
      ...
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            ...
            <button onClick={() => list.updateItem(1, "Updated")}>
              Update
            </button>
          </div>
        );
    ...
    it("应该支持列表过滤和排序", () => {
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            <button onClick={() => store.setSortBy("name")}>
              Sort by Name
            </button>
            <button onClick={() => store.setSortBy("price")}>
              Sort by Price
            </button>
            <button onClick={() => store.setFilterPrice(10)}>
              {"Filter >= 10"}
            </button>
            <ul>
      ...
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            ...
            <button onClick={() => cart.addItem(1, "Apple", 10)}>
              Add Apple
            </button>
            <button onClick={() => cart.addItem(2, "Banana", 5)}>
              Add Banana
            </button>
      ...
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            ...
            <button onClick={() => store.setDimensions(15, 15)}>
              Make Square
            </button>
          </div>
        );
      ...
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            ...
            <button onClick={() => state.setNullable("nullable")}>
              Set Nullable
            </button>
          </div>
        );
      ...
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            ...
            <button onClick={() => state.setLoading(!state.isLoading)}>
              Toggle Loading
            </button>
          </div>
        );
      ...
      const TestComponent = observer(() => {
        ...
        return (
          <div>
            ...
            <div>{state.name}</div>
            <button onClick={() => state.increment()}>+1</button>
            <button onClick={() => state.setName("updated")}>
              Update Name
            </button>
          </div>
        );
