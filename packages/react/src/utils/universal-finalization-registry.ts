 ...
 *
 * 注意：通过 globalThis 访问，避免在 React Native（Hermes/JSC）等
 * 不支持 FinalizationRegistry 的环境中抛出 ReferenceError
 */
const NativeFinalizationRegistry = (
  globalThis as typeof globalThis & {
    FinalizationRegistry?: typeof FinalizationRegistryType;
  }
).FinalizationRegistry;

export const UniversalFinalizationRegistry =
  NativeFinalizationRegistry === undefined
