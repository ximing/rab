...
// 页面组件
import InheritanceDemo from "./modules/domain/InheritanceDemo.js";
...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: (
          <Link to="/use-as-observable-source">useAsObservableSource 演示</Link>
        ),
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        key: "/service-inheritance",
        label: <Link to="/service-inheritance">Service 继承验证</Link>,
      },
    ],
  },
];
        ...
        <Layout style={{ padding: "24px" }}>
          ...
          >
            <Routes>
              ...
              <Route
                path="/minimal-observable"
                element={<MinimalObservableDemo />}
              />
              <Route path="/todolist" element={<TodoListDemo />} />
              <Route path="/use-observer" element={<UseObserverDemo />} />
              <Route
                path="/use-local-observable"
                element={<UseLocalObservableDemo />}
              />
              <Route
                path="/use-as-observable-source"
                element={<UseAsObservableSourceDemo />}
              />
              ...
              <Route
                path="/use-observer-service"
                element={<UseObserverServiceDemo />}
              />
              <Route
                path="/service-inheritance"
                element={<InheritanceDemo />}
              />
            </Routes>
          </Content>
        </Layout>
